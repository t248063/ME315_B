...
```
 ...
 #Selecionamos as colunas DNO e SALARY.
...
```
 #Selecionamos as colunas DNO e SALARY, evitando duplicatas.
...
```
 #Selecionamos as colunas DNO e SALARY, evitando duplicatas e ordenando suas
respectivas linhas por DNO e SALARY.
...
-WHERE (STATE = 'MA' AND ACRES > 1000) OR (STATE = 'MA' AND FEE = 0.0)
 ...
 #As clausulas em questao sao logicamente equivalentes.
...
-WHERE NOT ACRES < 50 AND NOT STATE = 'MA'
 ...
 #Apenas a primeira e terceira sao equivalentes.
